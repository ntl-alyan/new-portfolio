...
export default function ContactSection({ achievementsData, heroData }) {
  ...
  const links = [
    ...
    heroData.linkedin && {
      icon: "linkedin",
      label: "LinkedIn",
      value: heroData.linkedin.replace(/^https?:\/\/(www\.)?/, ""),
      href: heroData.linkedin,
    },
    heroData.github && {
      icon: "github",
      label: "GitHub",
      value: heroData.github.replace(/^https?:\/\/(www\.)?/, ""),
              ...
              return (
                <Reveal key={i} delay={i * 0.06} className="award">
                  <span className="award-icon">
                    <Icon name={ACHIEVEMENT_ICONS[i] || "award"} size={20} />
                  </span>
                  <div>
          ...
          <Reveal className="contact-panel">
            ...
            <div className="contact-copy">
              ...
              <p className="contact-lead">
                Welcoming conversations about engineering leadership, full-stack
                architecture and new opportunities. Email is the best way to
                reach me.
              </p>
              <div className="contact-actions">
                ...
                >
                  Send an email <Icon name="arrow" size={16} />
                </a>
                <button
                  type="button"
