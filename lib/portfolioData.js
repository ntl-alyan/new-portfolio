...
let portfolioData = {
  ...
  about: {
    bio: "I'm a passionate Full Stack Developer with hands-on experience building end-to-end solutions — from responsive, high-performance frontends in Next.js to robust, secure backends in NestJS. I love working at the intersection of great engineering and great user experience, delivering products that are both technically sound and delightful to use.",
